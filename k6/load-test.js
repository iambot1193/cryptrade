...
// Caminho de leitura: preco (com cache Caffeine atras), verificacao do ledger inteiro
// (recomputa hash + assinatura de cada bloco) e health. Rode com a app de pe:
//   docker compose up -d
